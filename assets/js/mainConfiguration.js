    ...
    return (function () {
        ...
        var t = {
                7621: function (t, e, i) {
                    ...
                    u.push([
                        t.id,
                        '#mainConfiguration{font-family:"Open Sans",BlinkMacSystemFont,"Segoe UI",Roboto,"Helvetica Neue",Arial,sans-serif,"Apple Color Emoji","Segoe UI Emoji","Segoe UI Symbol" !important;font-size:inherit !important;position:fixed;top:0;right:0;height:100%;z-index:99999999;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;width:400px;background:#fff;-webkit-box-shadow:0 4px 18px 0 rgba(58,53,65,.14);box-shadow:0 4px 18px 0 rgba(58,53,65,.14);-webkit-transition:all .2s ease-in;-o-transition:all .2s ease-in;transition:all .2s ease-in;-webkit-transform:translateX(420px);-ms-transform:translateX(420px);transform:translateX(420px)}.dark-style #mainConfiguration{-webkit-box-shadow:0 4px 18px 0 rgba(19,17,32,.2);box-shadow:0 4px 18px 0 rgba(19,17,32,.2)}#mainConfiguration h5{position:relative;font-size:11px}#mainConfiguration>h5{flex:0 0 auto}#mainConfiguration .disabled{color:#d1d2d3 !important}#mainConfiguration .form-label{font-size:.9375rem}#mainConfiguration .form-check-label{font-size:.8125rem}#mainConfiguration .mainConfiguration-t-panel_header{font-size:1.125rem}#mainConfiguration.mainConfiguration-open{-webkit-transition-delay:.1s;-o-transition-delay:.1s;transition-delay:.1s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#mainConfiguration.mainConfiguration-open .custom-option.checked{color:var(--bs-primary);border-width:2px}#mainConfiguration.mainConfiguration-open .custom-option.checked .custom-option-content{border:none}#mainConfiguration.mainConfiguration-open .custom-option .custom-option-content{border:1px solid rgba(0,0,0,0)}#mainConfiguration .mainConfiguration-header a:hover{color:inherit !important}#mainConfiguration .mainConfiguration-open-btn{position:absolute;top:180px;left:0;z-index:-1;display:block;width:42px;height:42px;border-top-left-radius:15%;border-bottom-left-radius:15%;background:var(--bs-primary);color:#fff !important;text-align:center;font-size:18px !important;line-height:42px;opacity:1;-webkit-transition:all .1s linear .2s;-o-transition:all .1s linear .2s;transition:all .1s linear .2s;-webkit-transform:translateX(-62px);-ms-transform:translateX(-62px);transform:translateX(-62px)}@media(max-width: 991.98px){#mainConfiguration .mainConfiguration-open-btn{top:145px}}.dark-style #mainConfiguration .mainConfiguration-open-btn{background:var(--bs-primary)}#mainConfiguration .mainConfiguration-open-btn::before{content:"";width:22px;height:22px;display:block;background-size:100% 100%;position:absolute;background-image:url(' +
                            d +
                            ');margin:10px}.customizer-hide #mainConfiguration .mainConfiguration-open-btn{display:none}[dir=rtl] #mainConfiguration .mainConfiguration-open-btn{border-radius:0;border-top-right-radius:15%;border-bottom-right-radius:15%}[dir=rtl] #mainConfiguration .mainConfiguration-open-btn::before{margin-left:-2px}#mainConfiguration.mainConfiguration-open .mainConfiguration-open-btn{opacity:0;-webkit-transition-delay:0s;-o-transition-delay:0s;transition-delay:0s;-webkit-transform:none !important;-ms-transform:none !important;transform:none !important}#mainConfiguration .mainConfiguration-inner{position:relative;overflow:auto;-webkit-box-flex:0;-ms-flex:0 1 auto;flex:0 1 auto;opacity:1;-webkit-transition:opacity .2s;-o-transition:opacity .2s;transition:opacity .2s}#mainConfiguration .mainConfiguration-inner>div:first-child>hr:first-of-type{display:none !important}#mainConfiguration .mainConfiguration-inner>div:first-child>h5:first-of-type{padding-top:0 !important}#mainConfiguration .mainConfiguration-themes-inner{position:relative;opacity:1;-webkit-transition:opacity .2s;-o-transition:opacity .2s;transition:opacity .2s}#mainConfiguration .mainConfiguration-theme-item{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;align-items:center;-ms-flex-align:center;-webkit-box-flex:1;-ms-flex:1 1 100%;flex:1 1 100%;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;margin-bottom:10px;padding:0 24px;width:100%;cursor:pointer}#mainConfiguration .mainConfiguration-theme-item input{position:absolute;z-index:-1;opacity:0}#mainConfiguration .mainConfiguration-theme-item input~span{opacity:.25;-webkit-transition:all .2s;-o-transition:all .2s;transition:all .2s}#mainConfiguration .mainConfiguration-theme-item .mainConfiguration-theme-checkmark{display:inline-block;width:6px;height:12px;border-right:1px solid;border-bottom:1px solid;opacity:0;-webkit-transition:all .2s;-o-transition:all .2s;transition:all .2s;-webkit-transform:rotate(45deg);-ms-transform:rotate(45deg);transform:rotate(45deg)}[dir=rtl] #mainConfiguration .mainConfiguration-theme-item .mainConfiguration-theme-checkmark{border-right:none;border-left:1px solid;-webkit-transform:rotate(-45deg);-ms-transform:rotate(-45deg);transform:rotate(-45deg)}#mainConfiguration .mainConfiguration-theme-item input:checked:not([disabled])~span,#mainConfiguration .mainConfiguration-theme-item:hover input:not([disabled])~span{opacity:1}#mainConfiguration .mainConfiguration-theme-item input:checked:not([disabled])~span .mainConfiguration-theme-checkmark{opacity:1}#mainConfiguration .mainConfiguration-theme-colors span{display:block;margin:0 1px;width:10px;height:10px;border-radius:50%;-webkit-box-shadow:0 0 0 1px rgba(0,0,0,.1) inset;box-shadow:0 0 0 1px rgba(0,0,0,.1) inset}#mainConfiguration.mainConfiguration-loading .mainConfiguration-inner,#mainConfiguration.mainConfiguration-loading-theme .mainConfiguration-themes-inner{opacity:.2}#mainConfiguration.mainConfiguration-loading .mainConfiguration-inner::after,#mainConfiguration.mainConfiguration-loading-theme .mainConfiguration-themes-inner::after{content:"";position:absolute;top:0;right:0;bottom:0;left:0;z-index:999;display:block}@media(max-width: 1200px){#mainConfiguration{display:none;visibility:hidden !important}}@media(max-width: 575.98px){#mainConfiguration{width:300px;-webkit-transform:translateX(320px);-ms-transform:translateX(320px);transform:translateX(320px)}}.layout-menu-100vh #mainConfiguration{height:100vh}[dir=rtl] #mainConfiguration{right:auto;left:0;-webkit-transform:translateX(-420px);-ms-transform:translateX(-420px);transform:translateX(-420px)}[dir=rtl] #mainConfiguration .mainConfiguration-open-btn{right:0;left:auto;-webkit-transform:translateX(62px);-ms-transform:translateX(62px);transform:translateX(62px)}[dir=rtl] #mainConfiguration .mainConfiguration-close-btn{right:auto;left:0}#mainConfiguration .mainConfiguration-layouts-options[disabled]{opacity:.5;pointer-events:none}[dir=rtl] .mainConfiguration-t-style_switch_light{padding-right:0 !important}',
                        "",
                    ]),
                        (e.Z = u);
                },
                        ...
                        return (
                            ...
                            (i = [
                                        ...
                                        if (this._hasControls("themes")) {
                                            ...
                                            if (s) {
                                                ...
                                                this._loadStylesheets(
                                                    ((a = {}),
                                                    (n = r),
                                                    (o = document.querySelector(".mainConfiguration-theme-css")),
                                    ...
                                    value: function (e) {
                                        ...
                                        if (e !== this.settings.lang || a) {
                                            ...
                                            [
                                                ...
                                                var e = i.container.querySelector(".mainConfiguration-t-".concat(t));
                                                e && (e.textContent = n[t]);
                                            });
                                            for (var o = n.themes || {}, r = this.container.querySelectorAll(".mainConfiguration-theme-item") || [], l = 0, c = r.length; l < c; l++) {
                                                var u = r[l].querySelector('input[type="radio"]').value;
                                                r[l].querySelector(".mainConfiguration-theme-name").textContent = o[u] || this._getThemeByName(u).title;
                                            }
                                ...
                                },
                                {
                                    ...
                                    value: function () {
                                        ...
                                        // "" !== i || "" !== s || "" !== a || "" !== n || "" !== o || "" !== l || "" !== u ? this._showResetBtnNotification(!0) : this._showResetBtnNotification(!1),
                                            ...
                                            // Defalt navbar style
                                            (this.settings.layoutNavbarOptions = "static"),
                                    ...
                                    value: function () {
                                        ...
                                        this._cleanup(),
                                            (this.container = this._getElementFromString(
                                                '<div id="mainConfiguration" class="invert-bg-white"></div> '
                                            ));
                                        var s = this.container;
                                        this.settings.displayCustomizer ? s.setAttribute("style", "visibility: visible") : s.setAttribute("style", "visibility: hidden");
                                        var u = this.container.querySelector(".mainConfiguration-style");
                                            // d = u.querySelector(".mainConfiguration-styles-options");
                                        if (this._hasControls("style")) {
                                        } else u.parentNode.removeChild(u);
                                        var h = this.container.querySelector(".mainConfiguration-themes");
                                            // p = h.querySelector(".mainConfiguration-themes-options");
                                        if (this._hasControls("themes")) {
                                        } else h.parentNode.removeChild(h);
                                        var f = this.container.querySelector(".mainConfiguration-theming");
                                        this._hasControls("style") || this._hasControls("themes") || f.parentNode.removeChild(f);
                                        var v = this.container.querySelector(".mainConfiguration-layout");
                                        if (this._hasControls("rtl headerType contentLayout layoutCollapsed layoutNavbarOptions", !0)) {
                                            var g = this.container.querySelector(".mainConfiguration-directions");
                                            if (this._hasControls("rtl") && rtlSupport) {
                                            } else g.parentNode.removeChild(g);
                                            var x = this.container.querySelector(".mainConfiguration-headerOptions"),
                                            ...
                                            var C = this.container.querySelector(".mainConfiguration-content");
                                            if (this._hasControls("contentLayout")) {
                                            } else C.parentNode.removeChild(C);
                                            var N = this.container.querySelector(".mainConfiguration-layouts");
                                            if (this._hasControls("layoutCollapsed")) {

                                            } else N.parentNode.removeChild(N);
                                            var E = this.container.querySelector(".mainConfiguration-layoutNavbarOptions");
                                            if (this._hasControls("layoutNavbarOptions")) {} else E.parentNode.removeChild(E);
                                        } else v.parentNode.removeChild(v);
                                        setTimeout(function () {
                                            var e = t.container.querySelector(".mainConfiguration-layout");
                                ...
                                },
                                {
                                    key: "_loadingState",
                                    value: function (t, e) {
                                        this.container.classList[t ? "add" : "remove"]("mainConfiguration-loading".concat(e ? "-theme" : ""));
                                    },
                                },
                                {
