...
-- Execute this after importing the sql dump spearetly or elese the event will not work
-- CREATE EVENT call_MoveToLogAndDelete ON SCHEDULE EVERY 60 SECOND DO CALL `MoveToLogAndDelete`();

-- CREATE DATABASE cdac-k_ctf_archive;
